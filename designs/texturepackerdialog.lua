...
UI.TexturePackerSettings = wx.wxDialog (wx.NULL, wx.wxID_ANY, "Texture Packer Settings", wx.wxDefaultPosition, wx.wxSize( 668,583 ), wx.wxDEFAULT_DIALOG_STYLE )
	...
	UI.m_outputDir = wx.wxDirPickerCtrl( UI.m_panel1, wx.wxID_ANY, "", "Select a folder", wx.wxDefaultPosition, wx.wxDefaultSize, wx.wxDIRP_DEFAULT_STYLE + wx.wxDIRP_SMALL )
	...
	UI.m_packName = wx.wxTextCtrl( UI.m_panel1, wx.wxID_ANY, "", wx.wxDefaultPosition, wx.wxDefaultSize, 0 )
	...
	UI.m_imageFormat:SetSelection( 0 )
	...
	UI.m_maxPageWidth1 = wx.wxSpinCtrl( UI.TexturePackerSettings, wx.wxID_ANY, "", wx.wxDefaultPosition, wx.wxDefaultSize, wx.wxSP_ARROW_KEYS, 16, 2048, 1024 )
	UI.bMaxPageHeight:Add( UI.m_maxPageWidth1, 1, wx.wxALL, 5 )
